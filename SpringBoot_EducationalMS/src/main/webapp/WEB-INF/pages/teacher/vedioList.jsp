				...
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
							...
							<div><a href="/teacher/goAddVedio">上传课件</a></div>
				    </div>
				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${vedioList}" var="item">
								<tr>
									...
									<td>${item.time}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='/teacher/msgList?vid=${item.id}'">查看留言</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
