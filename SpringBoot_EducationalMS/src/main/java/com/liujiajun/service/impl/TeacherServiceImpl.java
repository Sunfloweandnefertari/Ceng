    ...
    public List<TeacherCustom> findByPaging(Integer page, Integer pageSize) throws Exception {
        ...
        if(list!=null && list.size()>0) {
        	...
        	for (TeacherCustom teacherCustom : list) {
        		String format = sdf.format(teacherCustom.getBirthyear());
        		String format2 = sdf.format(teacherCustom.getGrade());
        		teacherCustom.setStrBirthyear(format);
        		teacherCustom.setStrGrade(format2);
        	}
        }
